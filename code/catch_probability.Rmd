...
jan2_1 <- data_final %>%
            ...
            labs(title = "Starting field positions on all balls hit to qualified CFs in 2024",
...
jan2_2 <- data_final %>%
            ...
            labs(title = "Starting field positions on all balls hit to qualified OFs in 2024",
                 x = "Horizontal distance from home plate (ft)",
                 y = "Vertical distance from home plate (ft)") +
            theme_linedraw()
